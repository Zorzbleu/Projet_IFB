 ...
 * @param liste_bateau Change les valeurs des 5 structures boat de cette liste
 */
void initialization_boats_characteristics(boat *liste_bateau, int nb_bateaux);

/**Initialise une partie par défaut
 * Initialisation de la dimension des structures grid par une taille de 10*10
 * Initialisation des grilles avec le caractère par défaut ('_')
 * Initialisation des caractéristiques des n bateaux (5 par défaut)
 * @param boat_grid
 * @param user_grid
 * @param liste_bateaux
 * @param nb_bateaux
